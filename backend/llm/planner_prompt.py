...
count); set "text" to the label and provide "variants" for translations. For extracting semantic/dynamic text (e.g., "search result title", "top headline"), use strategy_hint: "vlm_read". This bypasses OCR and asks the vision model to read the specific text directly.
